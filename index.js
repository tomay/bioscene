...
function initMap() {
    ...
    var version = '1.1.0';
    MAP.overlays = {};
    MAP.overlays['forest1990']     = L.tileLayer.wms(url, { layers: 'pyramids:for1990merc', version:version, format: format, transparency: true, opacity:1});
    MAP.overlays['forest2000']     = L.tileLayer.wms(url, { layers: 'pyramids:for2000merc', version:version, format: format, transparency: true, opacity:1});
    MAP.overlays['forest2010']     = L.tileLayer.wms(url, { layers: 'pyramids:for2010merc', version:version, format: format, transparency: true, opacity:1});
